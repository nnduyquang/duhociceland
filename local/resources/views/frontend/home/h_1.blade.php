            ...
            <div class="col-md-4  wow fadeInRight">
                <div class="register">
                    ...
                    <div class="ip-name input-group" style="display: block">
                        <input name="name" type="text" placeholder="@lang('content.home_contact_name')" class="form-control input-text" style="display: inline-block;border-radius: unset">
                        <div class="invalid-feedback" style="font-size: 15px;font-weight:  bold;">
                            Please choose a username.
                        </div>
                    </div>
                    <div class="ip-phone input-group" style="display: block">
                        <input name="phone" type="text" placeholder="@lang('content.home_contact_phone')" class="form-control input-text" style="display: inline-block;border-radius: unset">
                        <div class="invalid-feedback" style="font-size: 15px;font-weight:  bold;">
                            Please choose a username.
                        </div>
                    </div>
                    <div class="ip-email input-group" style="display: block">
                        <input name="email" type="text" placeholder="@lang('content.home_contact_email')" class="form-control input-text" style="display: inline-block;border-radius: unset">
                        <div class="invalid-feedback" style="font-size: 15px;font-weight:  bold;">
                            Please choose a username.
                        </div>
                    </div>
                    <textarea name="description" rows="4" cols="50" placeholder="@lang('content.home_contact_message')"></textarea>
                    <div class="btn-submit">
                        {{--<a href="#">đăng ký</a>--}}
                        <div class="button-group">
                            <button  type="button" class="btn btn-contact submit-re">@lang('content.home_contact_button')<i
